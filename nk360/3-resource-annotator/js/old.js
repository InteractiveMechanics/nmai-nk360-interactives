Annotator = (function() {
      ...
      words.droppable({
        ...
        drop: function(event, ui) {
          ...
          // If the marker comes from the right, create the correct HTML structure and decrement the available resources
            ...
            pin.append('<textarea placeholder="" name="Annotation_Area"></textarea>');
    ...
    var deletePin = function(pin) {
      pin.append('<div class="delete-pin"><span>Permanently delete this note??</span><button class="btn confirm-delete">Delete</button><button class="btn undo-delete">Cancel</button></div>');
